...
var ASM_CONSTS = [function($0, $1) { MbedJSHal.gpio.write($0, $1); },
 function($0, $1) { MbedJSHal.gpio.init_analogin($0, $1); },
 function($0) { return MbedJSHal.gpio.read($0); },
 function($0, $1) { MbedJSHal.gpio.mode($0, $1); },
 function($0, $1) { MbedJSHal.gpio.init_in($0, $1, 3); },
 function($0, $1, $2) { MbedJSHal.gpio.init_in($0, $1, $2); },
 function($0, $1) { MbedJSHal.gpio.init_out($0, $1, 0); },
 function($0, $1) { MbedJSHal.gpio.irq_init($0, $1); },
 function($0, $1, $2) { MbedJSHal.gpio.irq_set($0, $1, $2); },
 function($0, $1) { MbedJSHal.gpio.dir($0, $1); },
 function($0, $1) { MbedJSHal.gpio.init($0, $1); },
 function($0) { return window.MbedJSHal.serial.init($0) },
 function() { return window.MbedJSHal.serial.readable() },
 function() { return window.MbedJSHal.serial.read() },
 function($0) { window.MbedJSHal.serial.write($0) },
 function() { window.MbedJSHal.usticker.init(); },
 function() { return window.MbedJSHal.usticker.read(); },
 function($0) { window.MbedJSHal.usticker.setInterrupt($0); },
 function() { window.MbedJSHal.usticker.disableInterrupt(); },
 function() { window.MbedJSHal.usticker.fireInterrupt(); },
 function() { window.MbedJSHal.usticker.clearInterrupt(); },
 function() { window.MbedJSHal.usticker.free(); },
 function() { location.reload(); },
 function() { return Math.floor(Math.random() * Math.floor(4294967296)); },
 function() { return MbedJSUI.AccelerometerSensorY.read(); },
 function() { return MbedJSUI.AccelerometerSensorX.read(); },
 function() { return MbedJSUI.AccelerometerSensorZ.read(); },
 function() { return MbedJSUI.LightSensor.read(); },
 function() { console.log("Internal MicroPython error. Simulator will reset in 10 seconds."); },
 function() { return MbedJSUI.TemperatureSensor.read(); },
 function($0) { return Math.floor(Math.random() * $0); },
 function() { ccall('set_script', 'null',['string'], [window.document.getElementById("script").value]); window.MbedJSUI.MicrobitDisplay.prototype.micropython_mode(); },
 function() { MicroPythonTests = {}; MicroPythonTests.currently_running = ""; MicroPythonTests.failed_tests = []; MicroPythonTests.run_all = function() { ccall('set_run_all_tests', 'null'); console.log("Reset MicroPython to start run.") }; MicroPythonTests.run = function(test) { MicroPythonTests.currently_running = test; var request = new XMLHttpRequest(); request.onreadystatechange = function() { if (request.readyState == 4 && request.status == 200) { ccall('set_script', 'null',['string'], [request.responseText]); ccall('set_running_test', 'null'); console.log("Test: " + test); } }; request.open("GET", test + '.py', true); request.send(null); window.MbedJSHal.serial.write("\r\
\
...
// {{PRE_LIBRARY}}
  ...
  err('missing function: llvm_returnaddress'); abort(-1);
  }
...
var real__handle_ethernet_sigio = asm["_handle_ethernet_sigio"]; asm["_handle_ethernet_sigio"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__handle_ethernet_sigio.apply(null, arguments);
};
...
var real__handle_usticker_interrupt = asm["_handle_usticker_interrupt"]; asm["_handle_usticker_interrupt"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__handle_usticker_interrupt.apply(null, arguments);
};

var real__invoke_serial_irq = asm["_invoke_serial_irq"]; asm["_invoke_serial_irq"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__invoke_serial_irq.apply(null, arguments);
};
...
var real__set_run_all_tests = asm["_set_run_all_tests"]; asm["_set_run_all_tests"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__set_run_all_tests.apply(null, arguments);
};

var real__set_running_test = asm["_set_running_test"]; asm["_set_running_test"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__set_running_test.apply(null, arguments);
};

var real__set_script = asm["_set_script"]; asm["_set_script"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__set_script.apply(null, arguments);
};
...
var _handle_ethernet_sigio = Module["_handle_ethernet_sigio"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_handle_ethernet_sigio"].apply(null, arguments) };
var _handle_interrupt_in = Module["_handle_interrupt_in"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_handle_interrupt_in"].apply(null, arguments) };
var _handle_usticker_interrupt = Module["_handle_usticker_interrupt"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_handle_usticker_interrupt"].apply(null, arguments) };
var _invoke_serial_irq = Module["_invoke_serial_irq"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_invoke_serial_irq"].apply(null, arguments) };
...
var _set_run_all_tests = Module["_set_run_all_tests"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_set_run_all_tests"].apply(null, arguments) };
var _set_running_test = Module["_set_running_test"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_set_running_test"].apply(null, arguments) };
var _set_script = Module["_set_script"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_set_script"].apply(null, arguments) };
